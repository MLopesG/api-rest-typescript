...
exports.deletarUsuario = exports.editUsuario = exports.salvarUsuario = exports.getUsuarios = void 0;
...
var getUsuarios = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response_1, filterEnderecos, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                if (!(req && req.query.id)) return [3 /*break*/, 3];
                return [4 /*yield*/, database_1.pool.query("SELECT * FROM usuario  where id = " + req.query.id)];
            case 1:
                response_1 = _a.sent();
            ...
            case 2:
                filterEnderecos = _a.sent();
                /// Atribribuir endereços ao usuário selecionado
                response_1.rows[0]['enderecos'] = filterEnderecos.rows;
                return [2 /*return*/, res.status(200).json({
                        status: true,
                        usuarios: response_1.rows
                    })];
            case 3: return [4 /*yield*/, database_1.pool.query('SELECT * FROM usuario order by nome asc')];
            case 4:
                response = _a.sent();
...
var salvarUsuario = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var usuarioBody, errors, save;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, database_1.pool.query('INSERT INTO usuario (nome, telefone, email, idade, peso, etinia) VALUES ($1, $2, $3, $4, $5, $6)', Object.values(usuarioBody))];
            case 1:
                save = _a.sent();
                if (save) {
                    return [2 /*return*/, res.status(200).json({
...
var editUsuario = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var usuarioBody, errors, saveEdit;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                usuarioBody = req.body;
                ...
                return [4 /*yield*/, database_1.pool.query("update usuario set nome = $1, telefone = $2, email = $3, idade = $4, peso = $5, etinia = $6 WHERE id = " + req.params.id, Object.values(usuarioBody))];
            case 1:
                saveEdit = _a.sent();
                if (saveEdit) {
                    return [2 /*return*/, res.status(200).json({
...
var deletarUsuario = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database_1.pool.query("DELETE FROM usuario where id = " + req.params.id + "; DELETE FROM endereco where usuario_id = " + req.params.id)];
            case 1:
                usuarioDeletar = _a.sent();
                if (usuarioDeletar) {
                    return [2 /*return*/, res.status(200).json({
                            status: true,
